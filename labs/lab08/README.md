...
bgw-01#show ip bgp summary vrf ten-1
BGP summary information for VRF ten-1
...
bgw-01#
bgw-01#
bgw-01#show ip bgp summary vrf ten-2
BGP summary information for VRF ten-2
...
bgw-01#show ip route vrf ten-1
...
bgw-01#
bgw-01#
bgw-01#show ip route vrf ten-2
...
Результат: в ten-2 есть маршрут до C 192.168.50.0/24 на Leaf-04 через VNI 50002
...
Результат: 
присутствуют 0.0.0.0/0, 10.64.164.0/23 с RD/RT ten-1 и ten-2;
next-hop — VTEP BGWs.
